...
import type { ExtractedCard } from "@/types/card";
...
export default function ScanUploader() {
  ...
  const [stableQrFrames, setStableQrFrames] =
    useState(0);

  const [isAutoCapturing, setIsAutoCapturing] =
    useState(false);
  ...
  return (
    <div className="space-y-6">
      ...
      {!isCameraActive &&
        step === "front" &&
        !frontPreview && (
          <div className="border-2 border-dashed border-gray-300 rounded-2xl p-6 sm:p-10 text-center bg-gradient-to-b from-gray-50 to-white">
      ...
      {isCameraActive && (
        <div className="relative rounded-2xl overflow-hidden bg-black shadow-xl">
          ...
          <video
            ...
            playsInline
            muted
            className="w-full aspect-[3/4] sm:aspect-[4/3] object-cover max-h-[70vh] sm:max-h-[480px]"
          />
