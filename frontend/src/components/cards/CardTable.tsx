  ...
  <p className="mb-4 text-sm text-gray-500">
    Showing {filteredCards.length} of {cards.length} cards
          ...
          >
            <div className="flex items-start justify-between gap-3 mb-3">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  {card.designation && (
                    <p className="text-xs text-gray-500 truncate">{card.designation}</p>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2 min-w-0">
                {card.company_logo ? (
                  <img
                    ...
                    className="h-7 w-7 shrink-0 rounded-md object-contain border border-gray-200 bg-white p-0.5"
                  />
                ) : (
              ...
              {card.email && (
                <a
                  ...
                  className="block text-gray-600 hover:text-indigo-600 truncate"
                >
                  {card.email}
                </a>
              )}
              {card.phone && (
                <p className="text-gray-600 truncate">{card.phone}</p>
              )}
              {card.address && (
                <p className="text-gray-500 text-xs line-clamp-2">{card.address}</p>
              )}
            ...
            <div className="mt-4 flex items-center gap-2 border-t border-gray-100 pt-3">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 h-9 rounded-lg text-indigo-600 bg-indigo-50 hover:bg-indigo-100 text-sm font-medium transition-colors"
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 h-9 rounded-lg text-emerald-600 bg-emerald-50 hover:bg-emerald-100 text-sm font-medium transition-colors"
              >
              ...
              <button
                ...
                className="h-9 w-9 shrink-0 flex items-center justify-center text-red-600 bg-red-50 hover:bg-red-100 rounded-lg transition-colors disabled:opacity-50"
                title="Delete"
              >
      ...
      {/* =================================================
          DESKTOP TABLE
      ================================================= */}
      <div className="hidden md:block w-full overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm">
    ...
    >
      ...
      {selectedCard && (
        ...
        >
          ...
          <div
            className="w-full max-w-3xl max-h-[92vh] sm:max-h-[90vh] overflow-y-auto rounded-t-2xl sm:rounded-2xl bg-white shadow-2xl"
            onClick={(e) =>
              e.stopPropagation()
            }
          >
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-white px-4 sm:px-6 py-4 sm:py-5">
            ...
            <div className="sticky bottom-0 flex justify-end border-t border-gray-200 bg-white px-4 sm:px-6 py-3 sm:py-4">
